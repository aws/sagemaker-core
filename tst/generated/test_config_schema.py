...
def test_config_schema():
    ...
    assert SAGEMAKER_PYTHON_SDK_CONFIG_SCHEMA["properties"]["SageMaker"]["required"] == ["PythonSDK"]

    assert SAGEMAKER_PYTHON_SDK_CONFIG_SCHEMA["properties"]["SageMaker"]["properties"]["PythonSDK"]
    assert SAGEMAKER_PYTHON_SDK_CONFIG_SCHEMA["properties"]["SageMaker"]["properties"]["PythonSDK"]["required"] == ["Resources"]

    assert SAGEMAKER_PYTHON_SDK_CONFIG_SCHEMA["properties"]["SageMaker"]["properties"]["PythonSDK"]["properties"]["Resources"]
