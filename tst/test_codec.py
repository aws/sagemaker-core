...
def test_deserializer_for_structure_type():
    ...
    describe_model_response = {'CreationTime': datetime.datetime(2024, 3, 13, 15, 7, 44, 459000, tzinfo=tzlocal()),
...
def test_deserializer_for_list_type():
    ...
    describe_model_response = {'CreationTime': datetime.datetime(2024, 3, 13, 15, 7, 44, 459000, tzinfo=tzlocal()),
     'DeploymentRecommendation': {'RealTimeInferenceRecommendations': [
         {'RecommendationId': "dummy-recomm-id-1", "InstanceType": "mlt4",
          "Environment": {"ENV_VAR_1": "ENV_VAR_1_VALUE"}},
         {'RecommendationId': "dummy-recomm-id-2", "InstanceType": "mlm4",
...
def test_deserializer_for_map_type():
    ...
    describe_trial_component_response = {'CreatedBy': {},
         'DisplayName': 'huggingface-pytorch-training-2024-01-10-02-32-59-730-aws-training-job',
         'OutputArtifacts': {'SageMaker.DebugHookOutput': {'Value': 's3://sagemaker-us-west-2-616250812882/session-default-prefix/'},
                             'SageMaker.ModelArtifact': {'Value': 's3://sagemaker-us-west-2-616250812882/session-default-prefix/huggingface-pytorch-training-2024-01-10-02-32-59-730/output/model.tar.gz'}},
         'Parameters': {'SageMaker.ImageUri': {'StringValue': '763104351884.dkr.ecr.us-west-2.amazonaws.com/huggingface-pytorch-training:2.0.0-transformers4.28.1-gpu-py310-cu118-ubuntu20.04'},
    ...
    assert output_artifacts["SageMaker.DebugHookOutput"].value == 's3://sagemaker-us-west-2-616250812882/session-default-prefix/'
    ...
    describe_auto_ml_job_v2_response = {
        ...
        'AutoMLProblemTypeConfig': {'TabularJobConfig': {'CompletionCriteria': {'MaxCandidates': 3},
                                    ...
                                    'TimeSeriesForecastingJobConfig': {
                                        'Transformations':{
                                           'Filling': {"map1_key": {"map2_key": "map2_val"}}
                                        },
        ...
        'BestCandidate': {'CandidateName': 'python-sdk-integ-test-base-jobTA-001-143b672d',
                          ...
                          'CandidateSteps': [{
                                  ...
                                  'CandidateStepType': 'AWS::SageMaker::TransformJob'},
                              {
                                  ...
                                  'CandidateStepType': 'AWS::SageMaker::TrainingJob'}],
                          'CreationTime': datetime.datetime(2021, 10, 4, 11, 5, 38,
                                                            tzinfo=tzlocal()),
                          'InferenceContainerDefinitions': {
                            "def1": [
                                {'Image': "dummy-image-1", 'ModelDataUrl': "dummy-model-data-url-1",
                                 "Environment": {"ENV_VAR_1": "ENV_VAR_1_VALUE"}},
                                {'Image': "dummy-image-2", 'ModelDataUrl': "dummy-model-data-url-2",
                                 "Environment": {"ENV_VAR_2": "ENV_VAR_2_VALUE"}}
                                ]
                            },
